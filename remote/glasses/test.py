...
def phase2_open_serial():
    ...
    while True:
        try:
            # kill agetty if it respawns
            os.system('sudo systemctl stop getty@ttyS0.service 2>/dev/null')
            os.system('sudo systemctl stop serial-getty@ttyS0.service 2>/dev/null')
